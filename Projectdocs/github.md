...
4. Smoke **`https://write.arabivo.net`** (sign-in, paywall, lesson save, **Next** in a completed section; **`/lessons`** shows **four** units including **Challenge words**; **`/try`** demo works without sign-in — see **`launch-checklist.md`**).  
