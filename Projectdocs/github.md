...
4. Smoke **`https://write.arabivo.net`** (sign-in, **`/subscribe`** lifetime + monthly cards, lesson save, **Next** in a completed section; **`/dashboard`** daily challenge + billing card; **`/lessons`** unit blocks; **`/daily`** streak; **`/onboarding`** → sign-up → **`/subscribe`** — see **`launch-checklist.md`**).  
