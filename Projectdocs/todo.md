...
- **Marketing landing (handoff):** **`/`**, **`/try`**, and **`/daily`** rebuilt from **`Projectdocs/Landing Page.html`** — Fredoka/Hanken/Noto Naskh, hero + **`#challenge`** (daily word rotation), features, pricing, footer; **`components/marketing/marketing.css`**, **`MarketingTrialCTAs`**, **`LandingChallengeSection`**.  
